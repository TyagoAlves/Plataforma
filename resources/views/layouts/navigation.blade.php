<nav x-data="{ open: false }" class="backdrop-blur-xl bg-gray-900/80 border-b border-white/10" style="isolation: isolate;">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('study.dashboard')" :active="request()->routeIs('study.dashboard')">
                        {{ __('Estudos') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('study.dashboard')" :active="request()->routeIs('study.dashboard')">
                {{ __('Estudos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('study.opencode.index')" :active="request()->routeIs('study.opencode.*')">
                {{ __('OpenCode') }}
            </x-responsive-nav-link>
        </div>
